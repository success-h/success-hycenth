---
title: "UseState In React.JS - React Hooks"
publishedAt: "2021-09-19"
summary: "Learn what useState is and how to use useEffect in React"
---

## Introduction

React hooks allow you to perform side effects in function components. In this post, we will take a look at `useState` and give examples
of how to use in in [React.js](https://react.org/).
